...
import (
	...
	httpserver "github.com/keepguard/bff-core/internal/adapters/in/http"
	handlersPkg "github.com/keepguard/bff-core/internal/adapters/in/http/handlers"
	middlewarePkg "github.com/keepguard/bff-core/internal/adapters/in/http/middleware"
	httpclient "github.com/keepguard/bff-core/internal/adapters/out/http/client"
	auditdecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/audit"
	billingdecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/billing"
	collectordecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/collector"
	communicationdecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/communication"
	companydecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/company"
	consentdecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/consent"
	consentdocdecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/consentdocument"
	guardiandecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/guardian"
	knowledgedecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/knowledge"
	llmdecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/llmgateway"
	oauthdecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/oauthclient"
	tokendecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/servicetoken"
	userdecorator "github.com/keepguard/bff-core/internal/adapters/out/http/decorator/user"
	auditPublisher "github.com/keepguard/bff-core/internal/adapters/out/messaging/audit"
	messagingDecorator "github.com/keepguard/bff-core/internal/adapters/out/messaging/decorator"
	rabbitmqPublisher "github.com/keepguard/bff-core/internal/adapters/out/messaging/rabbitmq"
...
func main() {
	...
	server := httpserver.NewServer(cfg, appLogger, metricsInstance, rateLimiterMiddleware, redisClient, companyClient, auditEventPublisher).WithBillingClient(billingClient)
