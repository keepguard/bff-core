...
var catalog = []catalogItem{
	...
	{ID: "bff-invest", Name: "BFF Invest", Description: "BFF de investimentos e analista financeiro.", Group: "gateway", Endpoint: "GET /health", DefaultURL: "http://localhost:8383/health"},
	...
	{ID: "ms-ai-guardian", Name: "MS AI Guardian", Description: "Guardião de IA, moderação e detecção de riscos.", Group: "microservice", Endpoint: "GET /actuator/health/liveness", DefaultURL: "http://localhost:8088/actuator/health/liveness"},
	{ID: "ms-knowledge", Name: "MS Knowledge", Description: "Gestão de conhecimento, RAG e bases vetoriais.", Group: "microservice", Endpoint: "GET /actuator/health/liveness", DefaultURL: "http://localhost:8090/actuator/health/liveness"},
	{ID: "ms-analyst-finance", Name: "MS Analyst Finance", Description: "Motor de análise fundamentalista e valuation.", Group: "microservice", Endpoint: "GET /health", DefaultURL: "http://localhost:8640/health"},
	...
	{ID: "srv-audit", Name: "SRV Audit", Description: "Worker de auditoria e trilha de eventos.", Group: "worker", Endpoint: "GET /health", DefaultURL: "http://localhost:8620/health"},
	{ID: "srv-data-collector", Name: "SRV Data Collector", Description: "Coleta e ingestão agendada de dados externos.", Group: "worker", Endpoint: "GET /health", DefaultURL: "http://localhost:8630/health"},
	{ID: "srv-llm-gateway", Name: "SRV LLM Gateway", Description: "Gateway de proxy, quotas e fallback para LLMs.", Group: "worker", Endpoint: "GET /health", DefaultURL: "http://localhost:8650/health"},
