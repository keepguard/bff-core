...
func (s *serverImpl) SetupRoutes(handlers Handler) {
	...
	userGroup.POST("/core/llm/providers/:id/default", handlers.SetLlmProviderDefaultHandler, llmWrite...)
	userGroup.POST("/core/llm/complete", handlers.CompleteLlmHandler, llmWrite...)
	userGroup.GET("/core/llm/api-keys", handlers.ListLlmClientAPIKeysHandler, llmRead...)
	userGroup.POST("/core/llm/api-keys", handlers.CreateLlmClientAPIKeyHandler, llmWrite...)
	userGroup.POST("/core/llm/api-keys/:id/enable", handlers.EnableLlmClientAPIKeyHandler, llmWrite...)
	userGroup.POST("/core/llm/api-keys/:id/disable", handlers.DisableLlmClientAPIKeyHandler, llmWrite...)
	...
	userGroup.PUT("/core/billing/gateway-accounts/:gateway", handlers.PutBillingGatewayAccountByGatewayHandler, billingWrite...)
